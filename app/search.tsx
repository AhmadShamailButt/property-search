          ...
          <View style={styles.bottomSheet}>
            ...
            <ScrollView contentContainerStyle={{ padding: theme.spacing(3), gap: theme.spacing(3) }}>
              ...
              <View style={{ flexDirection: 'row', gap: 20, marginTop: 20 }}>
                ...
                <TouchableOpacity style={[styles.primaryBtn, { flex: 2 }]} onPress={() => setShowFilters(false)}><Text style={{ color: theme.colors.textInverse }}>Apply Filters</Text></TouchableOpacity>
              </View>
            </ScrollView>
          </View>
        </View>
