...
export default function AiChatScreen() {
  ...
  const sendMsg = () => {
    ...
    setInput('');
    setTimeout(() => {
      setMessages(m => [...m, { id: nextId(), role: 'ai', text: 'Based on the property documents, this villa has custom imported Italian marble and smart home integration throughout. (RAG Source: Description Docs)' }]);
    }, 1000);
  };
...
const styles = StyleSheet.create((theme) => ({
  ...
  aiBadgeText: { color: theme.colors.textInverse, ...theme.typography.label, fontWeight: '700' },
